...
На текущем этапе подготовлены архитектура, базовый Express backend и конфигурация PostgreSQL/Prisma. Прикладная логика заявок, API заявок, пользовательский интерфейс и миграции ещё не реализованы.
...
├── backend/
│   ├── prisma/
│   │   └── schema.prisma     # Подключение Prisma без моделей и миграций
│   ├── src/
